...
def open_test_data(number_of_batches):
    ...
    testing_data = np.zeros((number_of_batches,variables.train_batch_size,variables.num_variables), dtype=float) #variables by number of events in one batch by number of batches
    testing_target = np.zeros((number_of_batches,variables.train_batch_size,1))
